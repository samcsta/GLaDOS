...
- Finish before the injected deadline when saturation and every closure gate pass. If the deadline or run ceiling arrives first, mark the run `CAPPED` and incomplete; never claim a capped run is clean.
